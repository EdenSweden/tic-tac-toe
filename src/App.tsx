...
const reset: () => void = () => {
  ...
  return (
    <div className='flex justify-center items-center h-screen bg-blue-200 font-[cursive]'>
      <div id='background-box' className='ring-3 ring-violet-700 bg-linear-to-r from-indigo-400 to-violet-400 p-15 flex flex-col justify-center items-center gap-10 rounded-xl w-fit md:min-w-[455px]'>
        ...
        <button className='cursor-pointer rounded-lg p-5 bg-gray-200 hover:ring-3 hover:ring-fuchsia-600 text-xl' id='reset' onClick={reset}>Reset board</button>
    </div>
  </div>
  )
}
